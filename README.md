...
- **Multi-Agent Pipeline**:
  ...
  - 🕷️ **Reader Agent**: Scrapes and extracts deep text content from the top URLs, bypassing noise.
  - ✍️ **Writer Agent**: Synthesizes the gathered intelligence into a structured, comprehensive, and factual 1500+ word report.
